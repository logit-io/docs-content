...
<Cards>
  <Card title="Getting started with sending Logs" href="/log-management/getting-started" />
  <Card title="Getting started with sending Metrics" href="/infrastructure-metrics/getting-started" />
  <Card title="Getting started with sending  Traces" href="/application-performance-monitoring/getting-started" />
  <Card title="Getting started with sending  Opensearch Logs" href="/opensearch/creating-opensearch-cluster" />
</Cards>
