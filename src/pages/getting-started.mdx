...
<Cards>
  <Card title="Send Logs" href="/log-management/sending-data/get-started" />
  <Card title="Send Metrics" href="/infrastructure-metrics/sending-data/get-started" />
  <Card title="Send Traces" href="/application-performance-monitoring/sending-data/get-started" />
</Cards>