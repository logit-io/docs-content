...
<Callout type="info">
This guide uses the official Grafana Terraform provider version 2.x or later.
</Callout>
...
```hcl copy /@proxyAuthSetting.basicAuthHeader/ /@metrics_id/ filename="variables.tf"
...
variable "grafana_auth" {
  description = "Basic Auth header from Logit.io Profile Settings"
  type        = string
  sensitive   = true
  default     = "@proxyAuthSetting.basicAuthHeader"
}
```
