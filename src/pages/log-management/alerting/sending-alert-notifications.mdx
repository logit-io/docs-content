---
title: Options for Sending Alerts from Your Logs Stack for Different Scenarios
description: Setup and configure log alerting for more advanced scenarios including FAQs
---
