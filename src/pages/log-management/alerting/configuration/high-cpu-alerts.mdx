---
title: Configure OpenSearch Notifications for High CPU Alerts for Logs
description: Learn how to get started and explore OpenSearch Alerting for Log Management
---
