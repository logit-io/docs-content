...
Logit.io provides 6 [log management integration guides](/integrations/log-management/azure) 
and 3 [infrastructure metrics integration guides](/integrations/infrastructure-metrics/azure) for Azure. 
...
This [configuration](/integrations/infrastructure-metrics/azure/azure-kubernetes-logs) will 
...
monitoring efforts. This [integration](/integrations/infrastructure-metrics/azure/azure-kubernetes) achieves 
...
backup schedules and [integration](/integrations/log-management/azure/azure-eventhub-diagnostics) with 
...
integrations, [Azure Event Hub Diagnostic Logs](/integrations/log-management/azure/azure-eventhub-diagnostics).
...
the [predefined examples](/integrations/log-management/azure/azure-kubernetes-logs), you 
...
facilitating a swift [migration](/integrations/log-management/azure) of your log data.
...
With our [Azure SQL integration guide](/integrations/log-management/azure/azure-sql), 
...
Our [Azure AKS metrics integration guide](/integrations/infrastructure-metrics/time-series-database/azure-aks-metrics) 
...
Our [Azure container activity logs integration guide](/integrations/infrastructure-metrics/azure/azure-container-activity-logs) 
...
Unlock the power of the [Azure Metrics integration](/integrations/infrastructure-metrics/azure/azure-metrics) with 
