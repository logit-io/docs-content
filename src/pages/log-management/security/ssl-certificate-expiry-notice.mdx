...
Yes. The [updated certificate file](https://cdn.logit.io/root.logit.io.crt) contains both the old and new root certificates and should be updated as soon as possible. If you have any issues with the new certificate, please contact us.
