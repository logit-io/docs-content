...
metaTitle: Export OpenSearch Search Results to CSV & JSON
description: Learn how to export OpenSearch Dashboards dashboards, visualisations, and search results as CSV or JSON. Step-by-step guide for Logit.io hosted OpenSearch.
stackTypes: logs
---

# How can I export data from an OpenSearch Dashboards search on Logit?

To export data programmatically via the OpenSearch REST API (for example with a Python script), see [Export Data to CSV](/opensearch-api/examples/export-data-to-csv).
