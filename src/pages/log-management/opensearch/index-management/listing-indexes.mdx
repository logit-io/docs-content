---
title: List Indexes
metaTitle: How to List Indexes in OpenSearch
description: List all indexes in your OpenSearch cluster and check their status. Step-by-step guide using OpenSearch Dashboards Dev Tools on Logit.io.
stackTypes: logs
---
