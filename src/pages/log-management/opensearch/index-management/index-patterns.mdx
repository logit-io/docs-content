...
metaTitle: OpenSearch Index Patterns — Search Logs & Metrics
description: Create and manage index patterns in OpenSearch Dashboards to search logs and metrics on Logit.io. Includes defaults, wildcards, and refresh steps.
stackTypes: logs
---
...
logs sent to Logit.io using the [Filebeat shipper](/integrations/filebeat), 
