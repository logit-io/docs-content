...
<Callout type="warning">
    You will need to update any placeholder variables with your
    Stack and Proxy Auth details.
</Callout>
...
"Authorization: Basic {your-basic-auth-header}" https://kibana.logit.io/s/{your-logstack-id}/api/status
```
...
-u "{your-proxy-username}:{your-proxy-password}" https://kibana.logit.io/s/{your-logstack-id}/api/status
```
...
Elastic docs here [here](https://opensearch.org/docs/latest/api-reference/)