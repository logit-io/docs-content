---
title: Add UDP Input
description: Learn how to configure a UDP Input on your Logstash Instance
---
...
This guide provides a step-by-step process for configuring a UDP input in Logstash. 
