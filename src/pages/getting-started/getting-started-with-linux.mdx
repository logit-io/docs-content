...
description: Read Logit.io's Getting Started with Linux article and learn how to collect, process, and export telemetry data from Linux applications and system processes
...
You can find out more about configure Filebeat to send system logs [Link to filebeat system docs].
...
You can find more general information about Filebeat modules [Filebeat modules docs].
