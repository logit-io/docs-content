...
To learn more about how to create an Infrastructure Metrics stack click here [here](../infrastructure-metrics/)
...
Dashboards are collections of visualizations (panels). This [here](../infrastructure-metrics/visualizers/) to read more about them and how they are created.
...
After you have saved your new visualization you can then organise and customise, here are examples of some of the things you may want to do:

__Resize and Rearrange Panels__ - Drag and drop panels to arrange them as needed.

__Add Variables: Create variables__ - (like time ranges or filters) to make your dashboard dynamic and interactive.
...
__Business Metrics__ - Trigger alerts when sales or revenue drop significantly below expected levels or notify when user activity metrics (e.g., sign-ups or page views) deviate sharply 
from norms.
...
Grafana dashboards are customizable visual interfaces that consolidate and display metrics, logs, and traces from various data sources. They are composed of panels, each visualizing 
...
teams to make data-driven decisions effectively. To find out more about using Grafana Dashboards with Logit.io you can click [here](../log-management/opensearch/opensearch-dashboards/) 
