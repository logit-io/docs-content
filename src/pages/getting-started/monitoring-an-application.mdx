---
title: Monitoring an Application
metaTitle: Learn about Monitoring an Application
description: Read Logit.io’s Getting Started with Monitoring an Application article and learn how to monitor an application effectively
stackTypes: logs
---
...
Click [here](getting-started-with-filebeat/) to read more information about Filebeat and learn how to start sending logs to Logit.io.
...
Click [here](getting-started-with-opentelemetry/) to read more information about OpenTelemetry and learn how to start sending logs to Logit.io.
