...
description: Learn logs and metrics in an Linux environment
...
You can find more information about Filebeat modules [here](../getting-started/filebeat-modules.mdx).
