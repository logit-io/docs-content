...
description: Learn how to collect, process, and export telemetry data from software applications and system processes
stackTypes: logs, apm
---
...
Integrating with Logit.io enables comprehensive observability by collecting, processing, OpenTelemetry and visualizing telemetry data such as 
