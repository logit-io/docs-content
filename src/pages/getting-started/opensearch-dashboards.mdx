...
metaTitle: Learn about OpenSearch Dashboards
description: Learn how OpenSearch Dashboards provides powerful real-time dashboards, charts, and analytics for your log data
