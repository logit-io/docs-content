---
title: Filebeat Modules
metaTitle: Learn about sending logs to Logit.io via Filebeat using modules
description: Read Logit.io's Getting Started with Filebeat modules article and learn about logs for various applications
stackTypes: logs
---
...
- System (OS logs) - see our [Filebeat System integration](../integrations/filebeat-system)
