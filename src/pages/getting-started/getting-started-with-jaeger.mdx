...
description: Read Logit.io’s Getting Started with Jaeger article and learn how Telegraf helps to visualize the flow of requests through a distributed system
stackTypes: apm
---

# Getting started with Jaeger

Jaeger is an open-source distributed tracing system that helps monitor and troubleshoot microservices architectures. By tracing requests as they flow through 
...
In this guide, we'll explain what Jaeger is, why it's used, and how you can start using it for effective tracing and monitoring in your application with Logit.io.

### What Does Jaeger Do?

Jaeger helps visualize the flow of requests through a distributed system by capturing distributed traces. Each trace represents a single request and is composed 
of spans, which are individual operations or events in the request lifecycle. Jaeger collects data about the following:
...
Once you have created your stack and sent data you can launch the Jaeger visualizer to view your APM stack's data by pressing the `Launch APM` button found at the top 
...
Clicking `Launch APM` will take you to your Jaeger instance.
...
Clicking on a specific trace.

Displays the sequence of spans (operations) in a trace.

Shows the duration of each span, helping identify bottlenecks.
