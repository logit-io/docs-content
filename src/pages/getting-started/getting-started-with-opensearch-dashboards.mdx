...
Logs from multiple sources  can be stored in OpenSearch and visualized in one place.

**Monitor system health** 

Build dashboards that track infrastructure performance (CPU, memory, disk usage), application behavior, or uptime.

**Troubleshoot faster**

Filter and search through logs to quickly identify issues or anomalies.

**Create shareable reports**

Build and export custom dashboards for stakeholders or audit purposes.

**Visualize business intelligence**

Track KPIs and user behavior across applications.
...
Here are some examples of how the use search:
