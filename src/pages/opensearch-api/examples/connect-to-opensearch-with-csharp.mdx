...
[Creating an OpenSearch Cluster](/opensearch/creating-opensearch-cluster.mdx)
...
<Steps>
  ...
  * Install Serilog.Sinks.OpenSearch
  ...
  - [OpenSearch REST API](/opensearch-api) — search, bulk index, export to CSV, API guides
  - [OpenSearch Cluster Settings](/opensearch/opensearch-cluster-settings) — cluster configuration
  - [OpenSearch Overview](/opensearch/overview) — product overview
  - [Other examples](/opensearch-api/examples) — Python, Java, cURL
