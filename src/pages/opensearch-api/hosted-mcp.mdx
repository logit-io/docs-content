...
Related product pages: [Hosted OpenSearch MCP](https://logit.io/platform/features/hosted-opensearch-mcp/), [Hosted OpenSearch](https://logit.io/platform/features/hosted-opensearch/). New accounts can start with a [14-day trial](https://dashboard.logit.io/sign-up).
...
- [Hosted OpenSearch](https://logit.io/platform/features/hosted-opensearch/) — managed OpenSearch overview
- [Start a trial](https://dashboard.logit.io/sign-up) — 14 days, no credit card
