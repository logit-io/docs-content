...
| Read-only AI tooling (Cursor / Claude) | `{stack-id}-mcp.logit.io` — [Hosted MCP quickstart](/opensearch-api/hosted-mcp) |
...
- [Hosted MCP quickstart](/opensearch-api/hosted-mcp) — read-only AI clients
