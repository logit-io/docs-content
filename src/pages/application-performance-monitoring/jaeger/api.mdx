...
You can, if you choose to, connect your application directly to Logit.io to do a range of things such as saving traces, retrieve traces saved 
in the storage and service performance monitoring etc. or access Jaeger straight from your computer. 
