...
<Steps>
  ...
  These settings are what we need to connect to the OpenSearch Cluster, the rest of the article is a guide to where 
  to find your OpenSearch settings in the Logit.io Dashboard app.
