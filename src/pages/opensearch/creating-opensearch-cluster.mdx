...
metaTitle: Learn How to Create an OpenSearch Cluster
description: Learn how to create an OpenSearch cluster in Logit.io
pagination: false
timestamp: false
...
This article describes how to provision an OpenSearch cluster using Logit.io. An OpenSearch cluster is a collection of nodes that work together to store, search, and analyze your data. By following these steps, you'll have a fully functional OpenSearch environment ready for your logging and analytics needs.
...
<Steps>
  ...
  [Connect to an OpenSearch Cluster](connect-to-opensearch-cluster.mdx)
