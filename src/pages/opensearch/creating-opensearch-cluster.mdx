...
<Steps>
  ...
  **If you are logged section **

  To get started, click the 'Add Stack' button at the top of your dashboard.

  ![Add Stack](@/images/getting-started/opensearch/addstack.png)

  You will see a list of all the available stack type, click the 'Add to Plan' button next to Hosted OpenSearch.

  ![Add To Plan](@/images/getting-started/opensearch/add-to-plan.png)
