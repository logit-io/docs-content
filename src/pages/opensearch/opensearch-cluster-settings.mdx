...
<Steps>
  ...
  ```text copy /'@elasticsearch.endpointAddress:strip_quotes'/ /'@elasticsearch.username:strip_quotes'/ /'@elasticsearch.password:strip_quotes'/
  Endpoint: '@elasticsearch.endpointAddress:strip_quotes'
