---
title: Amazon Lambda Cloudwatch
...
From your Amazon Console browse to the <a target="_blank" href="http://console.aws.amazon.com/lambda/home">Lambda functions</a> and choose Create Function.
...
[Amazon CloudFront integration](/integrations/log-management/aws/cloudfront), 
which accelerates content delivery, and [Amazon VPC integration](/integrations/log-management/aws/vpc), 
