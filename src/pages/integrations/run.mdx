...
metaTitle: Integrate and Configure Google Cloud Run to Send Logs
subTitle: Ship Google Cloud Run logs from Google Cloud Pub/Sub to Logstash
logo: googlecloud
color: "#205bb0"
...
<Steps>
  ...
  <LaunchStack utmMedium="google" utmCampaign="googlecloudrun" source="pubsubbeat" />
</Steps>
