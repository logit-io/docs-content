...
Cloud Compute is a comparable platform to [Microsoft Azure](/integrations/log-management/azure/azure) & 
[Amazon EC2](/integrations/infrastructure-metrics/aws/ec2) and is often used as it is relatively inexpensive 
