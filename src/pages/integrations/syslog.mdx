...
<Steps>
  ...
  where you cannot run one of the [beats shippers](/integrations/log-management/shippers?q=shippers).
  ...
  <LaunchStack utmMedium="logs" utmCampaign="syslog" source="syslog" />
