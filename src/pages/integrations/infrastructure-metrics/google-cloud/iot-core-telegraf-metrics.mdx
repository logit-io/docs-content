...
color: "#3c76d7"
description: Configure Telegraf to ship Google IOT Core metrics to your Logit.io stacks. Configure Telegraf to send Google IOT Core metrics to Logstash or Elastic. Get started using our Telegraf Google IOT Core metrics example configuration.
stackTypes: metrics
---
