---
title: Google Apigee Metrics via Telegraf
subTitle: Ship your Google Apigee Metrics via Telegraf to your Logit.io Stack
logo: googlecloud
color: "#3c76d7"
description: Configure Telegraf to ship Google Apigee metrics to your Logit.io stacks. Configure Telegraf to send Google Apigee metrics to Logstash or Elastic. Get started using our Telegraf Google Apigee metrics example configuration.
stackTypes: metrics
---
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Google_Apigee_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-GoogleApigee-metrics" />
...
[Google Firestore](/integrations/metrics/google-cloud/firestore-telegraf-metrics) metrics next. 
To delve into the transformative world 
of [Google Contact Center AI](/integrations/metrics/google-cloud/contact-center-ai-insights-telegraf-metrics) insights 
