...
combination empowers you to unlock the full potential of your [Google Compute Engine](/integrations/logs/google-cloud/compute-engine) 
and [Google Cloud VPN Metrics](/integrations/logs/google-cloud/vpn-telegraf-metrics). 
