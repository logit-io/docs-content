---
title: Aerospike Metrics via Telegraf
subTitle: Aerospike Metrics via Telegraf
logo: aerospike
color: "#4d4d4d"
description: Configure Telegraf to ship Aerospike metrics to your Logit.io stacks. Configure Telegraf to send Aerospike metrics to Logstash or Elastic. Get started using our Telegraf Aerospike metrics example configuration.
stackTypes: metrics
