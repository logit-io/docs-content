---
title: Burrow Metrics via Telegraf
subTitle: Ship your Burrow Metrics via Telegraf to your Logit.io Stack
logo: kafka
color: "#4d4d4d"
description: Configure Telegraf to ship Burrow metrics to your Logit.io stacks. Configure Telegraf to send Burrow metrics to Logstash or Elastic. Get started using our Telegraf Burrow metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Burrow_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-Burrow-metrics" />
