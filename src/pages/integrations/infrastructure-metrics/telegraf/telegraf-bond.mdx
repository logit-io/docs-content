---
title: Bond Metrics via Telegraf
subTitle: Ship your Bond Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Set up Telegraf for Sending Bond Metrics to Your Logit.io Stacks. Configure Telegraf to Transmit Bond Metrics to Logstash or Elasticsearch with Our Telegraf Example Configuration.
stackTypes: metrics
