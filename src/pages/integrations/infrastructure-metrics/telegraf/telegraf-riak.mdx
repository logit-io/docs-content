---
title: Riak Metrics via Telegraf
subTitle: Ship your Riak Metrics via Telegraf to your Logit.io Stack
logo: riak
color: "#4d4d4d"
description: Configure Telegraf to ship Riak metrics to your Logit.io stacks. Configure Telegraf to send Riak metrics to Logstash or Elastic. Get started using our Telegraf Riak metrics example configuration.
stackTypes: metrics
