---
title: Beanstalkd Metrics via Telegraf
subTitle: Ship your Beanstalkd Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Beanstalkd metrics to your Logit.io stacks. Configure Telegraf to send Beanstalkd metrics to Logstash or Elastic. Get started using our Telegraf Beanstalkd metrics example configuration.
stackTypes: metrics
