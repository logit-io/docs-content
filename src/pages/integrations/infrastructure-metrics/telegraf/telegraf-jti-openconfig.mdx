---
title: JTI OpenConfig Metrics via Telegraf
subTitle: Ship your JTI OpenConfig Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship JTI OpenConfig metrics to your Logit.io stacks. Configure Telegraf to send JTI OpenConfig metrics to Logstash or Elastic. Get started using our Telegraf JTI OpenConfig metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="JTI_OpenConfig_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-JTIOpenConfig-metrics" />
