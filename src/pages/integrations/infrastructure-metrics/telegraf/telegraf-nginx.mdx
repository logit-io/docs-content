---
title: Nginx Metrics via Telegraf
subTitle: Ship your Nginx Metrics via Telegraf to your Logit.io Stack
logo: nginx
color: "#4d4d4d"
description: Configure Telegraf to ship Nginx metrics to your Logit.io stacks. Configure Telegraf to send Nginx metrics to Logstash or Elastic. Get started using our Telegraf Nginx metrics example configuration.
stackTypes: metrics
