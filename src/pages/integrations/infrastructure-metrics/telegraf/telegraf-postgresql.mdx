---
title: PostgreSQL Metrics via Telegraf
subTitle: Ship your PostgreSQL Metrics via Telegraf to your Logit.io Stack
logo: postgresqlelephant
color: "#4d4d4d"
description: Configure Telegraf to ship PostgreSQL metrics to your Logit.io stacks. Configure Telegraf to send PostgreSQL metrics to Logstash or Elastic. Get started using our Telegraf PostgreSQL metrics example configuration.
stackTypes: metrics
