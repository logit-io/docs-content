---
title: Apache Cassandra Metrics via Telegraf
subTitle: Ship your Apache Cassandra Metrics via Telegraf to your Logit.io Stack
logo: cassandra
color: "#4d4d4d"
description: Configure Telegraf to ship Apache Cassandra metrics to your Logit.io stacks. Configure Telegraf to send Apache Cassandra metrics to Logstash or Elastic. Get started using our Telegraf Apache Cassandra metrics example configuration.
stackTypes: metrics
...
### View your metrics
<LaunchStack source="Apache_Cassandra_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-ApacheCassandra-metrics" />
