---
title: Memcached Metrics via Telegraf
subTitle: Ship your Memcached Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Memcached metrics to your Logit.io stacks. Configure Telegraf to send Memcached metrics to Logstash or Elastic. Get started using our Telegraf Memcached metrics example configuration.
stackTypes: metrics
