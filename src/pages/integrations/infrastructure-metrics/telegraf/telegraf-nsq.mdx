---
title: NSQ Metrics via Telegraf
subTitle: Ship your NSQ Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship NSQ metrics to your Logit.io stacks. Configure Telegraf to send NSQ metrics to Logstash or Elastic. Get started using our Telegraf NSQ metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="NSQ_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-NSQ-metrics" />
