---
title: Github Metrics via Telegraf
subTitle: Ship your Github Metrics via Telegraf to your Logit.io Stack
logo: github
color: "#4d4d4d"
description: Configure Telegraf to ship Github metrics to your Logit.io stacks. Configure Telegraf to send Github metrics to Logstash or Elastic. Get started using our Telegraf Github metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Github_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-Github-metrics" />
