---
title: Unbound Metrics via Telegraf
subTitle: Ship your Unbound Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Unbound metrics to your Logit.io stacks. Configure Telegraf to send Unbound metrics to Logstash or Elastic. Get started using our Telegraf Unbound metrics example configuration.
stackTypes: metrics
