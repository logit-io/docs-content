---
title: Prometheus Metrics via Telegraf
subTitle: Ship your Prometheus Metrics via Telegraf to your Logit.io Stack
logo: prometheus
color: "#4d4d4d"
description: Configure Telegraf to ship Prometheus metrics to your Logit.io stacks. Configure Telegraf to send Prometheus  metrics to Logstash or Elastic. Get started using our Telegraf Prometheus  metrics example configuration.
stackTypes: metrics
