---
title: Redfish Metrics via Telegraf
subTitle: Ship your Redfish Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Redfish metrics to your Logit.io stacks. Configure Telegraf to send Redfish metrics to Logstash or Elastic. Get started using our Telegraf Redfish metrics example configuration.
stackTypes: metrics
