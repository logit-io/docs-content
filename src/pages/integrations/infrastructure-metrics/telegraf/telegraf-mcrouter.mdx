...
color: "#4d4d4d"
description: Configure Telegraf to ship Mcrouter to your Logit.io stacks. Configure Telegraf to send Mcrouter to Logstash or Elastic. Get started using our Telegraf Mcrouter example configuration.
stackTypes: metrics
