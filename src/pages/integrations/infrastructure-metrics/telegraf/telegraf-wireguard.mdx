---
title: Wireguard Metrics via Telegraf
subTitle: Ship your Wireguard Metrics via Telegraf to your Logit.io Stack
logo: wireguard
color: "#4d4d4d"
description: Configure Telegraf to ship Wireguard metrics to your Logit.io stacks. Configure Telegraf to send Wireguard metrics to Logstash or Elastic. Get started using our Telegraf Wireguard metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Wireguard_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-Wireguard-metrics" />
