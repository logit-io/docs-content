---
title: NSQ Consumer Metrics via Telegraf
subTitle: Ship your NSQ Consumer Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship NSQ Consumer metrics to your Logit.io stacks. Configure Telegraf to send NSQ Consumer metrics to Logstash or Elastic. Get started using our Telegraf NSQ Consumer metrics example configuration.
stackTypes: metrics
