...
logo: haproxy
color: "#4d4d4d"
description: Configure Telegraf to ship HAproxy metrics to your Logit.io stacks. Configure Telegraf to send HAproxy metrics to Logstash or Elastic. Get started using our Telegraf HAproxy metrics example configuration.
stackTypes: metrics
