---
title: Argo CD Metrics via Telegraf
subTitle: Ship your Argo CD Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Argo CD metrics to your Logit.io stacks. Configure Telegraf to send Argo CD metrics to Logstash or Elastic. Get started using our Telegraf Argo CD metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Argo_CD_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-JTIOpenConfig-metrics" />
