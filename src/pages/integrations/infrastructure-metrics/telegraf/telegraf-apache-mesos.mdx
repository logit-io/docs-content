---
title: Apache Mesos Metrics via Telegraf
subTitle: Ship your Apache Mesos Metrics via Telegraf to your Logit.io Stack
logo: mesos
color: "#4d4d4d"
description: Configure Telegraf to ship Apache Mesos metrics to your Logit.io stacks. Configure Telegraf to send Apache Mesos metrics to Logstash or Elastic. Get started using our Telegraf Apache Mesos metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Apache_Mesos_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-ApacheMesos-metrics" />
