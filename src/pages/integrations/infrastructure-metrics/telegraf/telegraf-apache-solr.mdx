---
title: Apache Solr Metrics via Telegraf
subTitle: Ship your Apache Solr Metrics via Telegraf to your Logit.io Stack
logo: solr
color: "#4d4d4d"
description: Configure Telegraf to ship Apache Solr metrics to your Logit.io stacks. Configure Telegraf to send Apache Solr metrics to Logstash or Elastic. Get started using our Telegraf Apache Solr metrics example configuration.
stackTypes: metrics
