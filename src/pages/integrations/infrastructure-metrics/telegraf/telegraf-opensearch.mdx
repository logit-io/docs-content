---
title: OpenSearch Metrics via Telegraf
subTitle: Ship your OpenSearch Metrics via Telegraf to your Logit.io Stack
logo: opensearch
color: "#4d4d4d"
description: Configure Telegraf to ship OpenSearch metrics to your Logit.io stacks. Configure Telegraf to send OpenSearch metrics to Logstash or Elastic. Get started using our Telegraf OpenSearch metrics example configuration.
stackTypes: metrics
