---
title: Synproxy Metrics via Telegraf
subTitle: Ship your Synproxy Metrics via Telegraf to your Logit.io Stack
logo: ubuntu
color: "#4d4d4d"
description: Configure Telegraf to ship Synproxy metrics to your Logit.io stacks. Configure Telegraf to send Synproxy metrics to Logstash or Elastic. Get started using our Telegraf Synproxy metrics example configuration.
stackTypes: metrics
