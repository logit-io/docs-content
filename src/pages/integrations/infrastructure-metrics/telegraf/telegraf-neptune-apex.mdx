---
title: Neptune Apex Metrics via Telegraf
subTitle: Ship your Neptune Apex Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Neptune Apex metrics to your Logit.io stacks. Configure Telegraf to send Neptune Apex metrics to Logstash or Elastic. Get started using our Telegraf Neptune Apex metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="Neptune_Apex_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-NeptuneApex-metrics" />
