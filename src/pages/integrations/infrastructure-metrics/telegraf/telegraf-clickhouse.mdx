---
title: ClickHouse Metrics via Telegraf
subTitle: Ship your ClickHouse Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship ClickHouse metrics to your Logit.io stacks. Configure Telegraf to send ClickHouse metrics to Logstash or Elastic. Get started using our Telegraf ClickHouse metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="ClickHouse_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-ClickHouse-metrics" />
