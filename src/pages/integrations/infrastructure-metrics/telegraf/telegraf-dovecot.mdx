---
title: Dovecot Metrics via Telegraf
subTitle: Ship your Dovecot Metrics via Telegraf to your Logit.io Stack
logo: dovecot
color: "#4d4d4d"
description: Configure Telegraf to ship Dovecot metrics to your Logit.io stacks. Configure Telegraf to send Dovecot metrics to Logstash or Elastic. Get started using our Telegraf Dovecot metrics example configuration.
stackTypes: metrics
