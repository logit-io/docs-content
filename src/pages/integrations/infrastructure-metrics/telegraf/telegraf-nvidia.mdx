---
title: Nvidia SMI Metrics via Telegraf
subTitle: Ship your Nvidia SMI Metrics via Telegraf to your Logit.io Stack
logo: nvidia
color: "#4d4d4d"
description: Configure Telegraf to ship Nvidia SMI Metrics to your Logit.io stacks. Configure Telegraf to send Nvidia SMI Metrics to Logstash or Elastic. Get started using our Telegraf Nvidia SMI Metrics example configuration.
stackTypes: metrics
