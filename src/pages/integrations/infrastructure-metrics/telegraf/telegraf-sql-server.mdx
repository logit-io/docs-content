---
title: SQL Server Metrics via Telegraf
subTitle: Ship your SQL Server Metrics via Telegraf to your Logit.io Stack
logo: azure_sql
color: "#4d4d4d"
description: Configure Telegraf to ship SQL Server metrics to your Logit.io stacks. Configure Telegraf to send SQL Server metrics to Logstash or Elastic. Get started using our Telegraf SQL Server metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="SQL_Server_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-SQLServer-metrics" />
