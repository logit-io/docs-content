---
title: etcd Metrics via Telegraf
subTitle: Ship your etcd Metrics via Telegraf to your Logit.io Stack
logo: etcd
color: "#4d4d4d"
description: Configure Telegraf to ship etcd metrics to your Logit.io stacks. Configure Telegraf to send etcd metrics to Logstash or Elastic. Get started using our Telegraf etcd metrics example configuration.
stackTypes: metrics
