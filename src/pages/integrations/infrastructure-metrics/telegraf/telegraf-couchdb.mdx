---
title: CouchDB Metrics via Telegraf
subTitle: Ship your CouchDB Metrics via Telegraf to your Logit.io Stack
logo: couchdb
color: "#4d4d4d"
description: Configure Telegraf to ship CouchDB metrics to your Logit.io stacks. Configure Telegraf to send CouchDB metrics to Logstash or Elastic. Get started using our Telegraf CouchDB metrics example configuration.
stackTypes: metrics
