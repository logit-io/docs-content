---
title: Phusion Passenger Metrics via Telegraf
subTitle: Ship your Phusion Passenger Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Phusion Passenger metrics to your Logit.io stacks. Configure Telegraf to send Phusion Passenger metrics to Logstash or Elastic. Get started using our Telegraf Phusion Passenger metrics example configuration.
stackTypes: metrics
