---
title: Ceph Metrics via Telegraf
subTitle: Ship your Ceph Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship Ceph metrics to your Logit.io stacks. Configure Telegraf to send Ceph metrics to Logstash or Elastic. Get started using our Telegraf Ceph metrics example configuration.
stackTypes: metrics
