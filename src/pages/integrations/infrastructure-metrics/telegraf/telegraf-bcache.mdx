---
title: bCache Metrics via Telegraf
subTitle: Ship your bCache Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship bCache metrics to your Logit.io stacks. Configure Telegraf to send bCache metrics to Logstash or Elastic. Get started using our Telegraf bCache metrics example configuration.
stackTypes: metrics
