---
title: PHP-FPM Metrics via Telegraf
subTitle: PHP-FPM Metrics via Telegraf to your Logit.io Stack
logo: php
color: "#4d4d4d"
description: Configure Telegraf to ship PHP-FPM metrics to your Logit.io stacks. Configure Telegraf to send PHP-FPM metrics to Logstash or Elastic. Get started using our Telegraf PHP-FPM metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="PHP_FPM_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-PHP-FPM-metrics" />
