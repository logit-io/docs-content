---
title: PgBouncer Metrics via Telegraf
subTitle: Ship your PgBouncer Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship PgBouncer metrics to your Logit.io stacks. Configure Telegraf to send PgBouncer metrics to Logstash or Elastic. Get started using our Telegraf PgBouncer metrics example configuration.
stackTypes: metrics
