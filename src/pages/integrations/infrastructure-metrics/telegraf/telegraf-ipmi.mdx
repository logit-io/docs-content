---
title: IPMI Metrics via Telegraf
subTitle: Ship your IPMI Metrics via Telegraf to your Logit.io Stack
color: "#4d4d4d"
description: Configure Telegraf to ship IPMI metrics to your Logit.io stacks. Configure Telegraf to send IPMI metrics to Logstash or Elastic. Get started using our Telegraf IPMI metrics example configuration.
stackTypes: metrics
