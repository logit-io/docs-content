---
title: ZFS Metrics via Telegraf
subTitle: Ship your ZFS Metrics via Telegraf to your Logit.io Stack
logo: zfs
color: "#4d4d4d"
description: Configure Telegraf to ship ZFS metrics to your Logit.io stacks. Configure Telegraf to send ZFS metrics to Logstash or Elastic. Get started using our Telegraf ZFS metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  ### View your metrics
  <LaunchStack source="ZFS_Metrics_via_Telegraf" utmMedium="metrics" utmCampaign="telegraf-ZFS-metrics" />
