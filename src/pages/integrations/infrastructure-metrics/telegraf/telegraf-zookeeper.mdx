---
title: Zookeeper Metrics via Telegraf
subTitle: Ship your Zookeeper Metrics via Telegraf to your Logit.io Stack
logo: zookeeper
color: "#4d4d4d"
description: Configure Telegraf to ship Zookeeper metrics to your Logit.io stacks. Configure Telegraf to send Zookeeper metrics to Logstash or Elastic. Get started using our Telegraf Zookeeper metrics example configuration.
stackTypes: metrics
