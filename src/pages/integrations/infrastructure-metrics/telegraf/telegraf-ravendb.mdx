---
title: RavenDB Metrics via Telegraf
subTitle: Ship your RavenDB Metrics via Telegraf to your Logit.io Stack
logo: ravendb
color: "#4d4d4d"
description: Configure Telegraf to ship RavenDB metrics to your Logit.io stacks. Configure Telegraf to send RavenDB metrics to Logstash or Elastic. Get started using our Telegraf RavenDB metrics example configuration.
stackTypes: metrics
