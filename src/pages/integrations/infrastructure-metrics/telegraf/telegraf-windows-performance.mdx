...
logo: windows
color: "#4d4d4d"
description: Configure Telegraf to ship Windows Performance metrics to your Logit.io stacks. Configure Telegraf to send Windows Performance metrics to Logstash or Elastic. Get started using our Telegraf Windows Performance metrics example configuration.
stackTypes: metrics
