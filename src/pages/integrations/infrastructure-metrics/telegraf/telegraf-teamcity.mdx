---
title: TeamCity Server Metrics via Telegraf
subTitle: Ship your TeamCity Server Metrics via Telegraf to your Logit.io Stack
logo: teamcity
color: "#4d4d4d"
description: Configure Telegraf to ship TeamCity Server metrics to your Logit.io stacks. Configure Telegraf to send TeamCity Server metrics to Logstash or Elastic. Get started using our Telegraf TeamCity Server metrics example configuration.
stackTypes: metrics
...
<Steps>
  ...
  urls = ["https://<teamcity_server_url>/app/metrics"]
