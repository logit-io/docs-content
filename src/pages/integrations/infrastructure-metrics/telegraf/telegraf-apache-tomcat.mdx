---
title: Apache Tomcat Metrics via Telegraf
subTitle: Ship your Apache Tomcat Metrics via Telegraf to your Logit.io Stack
logo: apachetomcat
color: "#4d4d4d"
description: Configure Telegraf to ship Apache Tomcat metrics to your Logit.io stacks. Configure Telegraf to send Apache Tomcat metrics to Logstash or Elastic. Get started using our Telegraf Apache Tomcat metrics example configuration.
stackTypes: metrics
