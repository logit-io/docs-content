...
The Metricbeat Module for [HTTP](/integrations/logs/protocols/http). HTTP is a meticulously designed solution for monitoring 
services by collecting metrics via HTTP endpoints. Those already acquainted with [Metricbeat's](/integrations/logs/shippers/metricbeat) 
