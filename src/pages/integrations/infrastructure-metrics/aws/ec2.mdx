...
traffic. [Amazon ELB Application (Elastic Load Balancer)](/integrations/logs/aws/elb-application) 
...
[Amazon S3 (Simple Storage Service)](/integrations/logs/aws/s3). Storing your logs and data 
