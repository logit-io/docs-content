---
title: Integrate and Configure Logstash to Send Amazon EC2 Metrics 
...
traffic. [Amazon ELB Application (Elastic Load Balancer)](/integrations/log-management/aws/elb-application) 
...
[Amazon S3 (Simple Storage Service)](/integrations/log-management/aws/s3). Storing your logs and data 
