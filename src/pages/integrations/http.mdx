...
This is a great way to send logs from applications that do not have a native integration with Logit.io or if you want to send logs from a custom application.
