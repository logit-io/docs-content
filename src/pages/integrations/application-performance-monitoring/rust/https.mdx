---
title: OpenTelemetry Rust (HTTP/S)
pageTitle: OpenTelemetry Rust (HTTP/S) Configuration
subTitle: Ship traces from Rust to OpenSearch with OpenTelemetry (via HTTP/S)
logo: rust
color: "#0f172a"
stackTypes: apm
...
<Steps>
  ...
  ```rust copy showLineNumbers /@opentelemetry.base64encodedAuthString/ /@opentelemetry.endpointAddress/ /@opentelemetry.httpsPort/
  ...
  <LaunchStack utmMedium="apm" utmCampaign="rust" source="apm_rust_http" />
