---
title: OpenTelemetry Java (HTTP/S)
pageTitle: OpenTelemetry Java (HTTP/S) Configuration
subTitle: Ship traces from Java to OpenSearch with OpenTelemetry (via HTTP/S)
logo: java
color: "#f39100"
stackTypes: apm
description: Use our example configuration to ship your Java program traces to OpenSearch. Send Java program traces to your Logit.io stacks.
protocol: https
protocolName: http
---
...
<Steps>
  ...
  otel.exporter.otlp.endpoint=https://@opentelemetry.endpointAddress:@opentelemetry.port
  ...
  <LaunchStack utmMedium="apm" utmCampaign="java" source="apm_java_http" />
