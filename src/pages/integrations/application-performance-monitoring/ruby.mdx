...
Open a Terminal windows or Command Prompt and navigate into the new `opentelemetry_example` folder. 
...
Run the Ruby app by with the following command in Terminal or the Command Prompt window.
...
![Invite New Users](@/images/integrations/ruby/ruby-endpoint.png)
