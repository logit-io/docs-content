...
color: "#0e64a9"
stackTypes: apm
description: Use our configuration example to learn how to ship your Python script traces to OpenSearch. Send traces from Python to your Logit.io stacks.
protocol: grpc
---
