...
<Steps>
  ...
  <InstallFilebeat include={["DEB", "RPM"]} />
  ...
  <ValidateBeat beatname="filebeat" include={["DEB","RPM"]} />
  
  ### Start Filebeat

  <StartFilebeat include={["DEB","RPM"]} />
...
<Steps>
  ...
  <InstallTelegraf include={["DEB", "RPM"]} />
