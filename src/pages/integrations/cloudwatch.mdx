...
In the next section you want to attach an existing policy. Highlight attach existing policies and search the policy list below for your newly created policy.
