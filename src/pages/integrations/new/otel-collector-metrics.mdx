---
title: Metrics OpenTelemetry Collector
metaTitle: Integrate and Configure OpenTelemetry Collector to Send Metrics
subTitle: OpenTelemetry (OTEL) Collector for Metrics
logo: opentelemetry
color: "#2e62a4"
...
<Steps>
  ...
  the forwarding of metrics data directly to Logit.io's observability platform.
  ...
  **Comprehensive data collection:** This tool gathers logs, metrics, and tracing information, offering an all-encompassing platform for data observability 
  ...
  If not, make sure to replace the following placeholders with the correct details: `<your-metrics-username>`, `<your-metrics-password>`, `<your-metrics-stack-id>`.
  ...
  <LaunchStack stackType="metrics" utmMedium="otel" utmCampaign="metrics_otel_collector" source="metrics_otel_collector" />
