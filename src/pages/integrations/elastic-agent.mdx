---
title: Elastic Agent
metaTitle: Elastic Agent — Send Logs & Metrics to Logit.io
...
color: "#00bfb3"
popular: true
description: Configure Elastic Agent to ship logs and metrics to Logit.io via Logstash. Unified agent setup for OpenSearch stacks and observability pipelines.
stackTypes: logs
sslPortType: beats-ssl
tags: Beats, Logs, Elastic Agent, Files, Text, Log Files, Elastic Agent
---

Ship logs and metrics to Logit.io with Elastic Agent: install the agent, use the pre-built Logstash output config, and view data in OpenSearch Dashboards. Follow the steps below.
