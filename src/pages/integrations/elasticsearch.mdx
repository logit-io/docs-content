---
title: Elasticsearch
metaTitle: How to Integrate and Configure Filebeat to Send Elasticsearch Logs
...
<Steps>
  ...
  <Tabs items={["Windows", "Linux", "macOS", "DEB", "RPM"]}>
    <Tab>
      There are several built in filebeat modules you can use. You will need to enable the elasticsearch module:
      ...
      Copy the snippet below and replace the contents of the elasticsearch.yml module file:
