...
logo: kubernetes
color: "#3a64ad"
description: How to send Kubernetes container logs to your Hosted ELK Logstash instance. Configure Filebeat to send data to Logstash. Get started using our Filbeat Kubernetes configuration example.
stackTypes: logs
