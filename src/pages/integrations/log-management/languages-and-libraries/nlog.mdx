...
NLog is a free open source logging platform for [.NET](/integrations/logs/languages-and-libraries/dotnet) & 
[.NET Core](/integrations/logs/languages-and-libraries/dotnetcore), that is often compared to 
[Serilog](/integrations/logs/languages-and-libraries/serilog) & [Log4net](/integrations/logs/languages-and-libraries/log4net). 
