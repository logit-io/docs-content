---
title: .NET (Core / 5+)
metaTitle: Learn How to Integrate and Configure .NET to Send Logs
pageTitle: .NET Serilog Configuration
subTitle: Ship logs from ASP.NET to Logit.io with Serilog
logo: aspnetcore
color: "#5c2d91"
stackTypes: logs
