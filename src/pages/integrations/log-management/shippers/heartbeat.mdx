...
the Beats family, such as [Metricbeat](/integrations/logs/shippers/metricbeat) & [Winlogbeat](/integrations/logs/shippers/winlogbeat), 
...
Heartbeat supports [HTTP](/integrations/logs/protocols/http), ICMP and [TCP](/integrations/logs/protocols/tcp) protocols for monitoring 
