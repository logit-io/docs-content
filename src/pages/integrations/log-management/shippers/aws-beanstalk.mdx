---
title: Learn How to Integrate and Configure AWS Beanstalk to Send Logs
...
logs from AWS Beanstalk to one or more destinations, including Logstash.
...
<Steps>
  ...
  <LaunchStack utmMedium="logs" utmCampaign="AwsBeanstalk" source="awsbeanstalk" />
