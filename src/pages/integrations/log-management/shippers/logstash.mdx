...
Logstash server. Logit.io recommends using [Filebeat](/integrations/logs/shippers/filebeat) to ship your logs and metrics to 
...
sources including [Golang](/integrations/logs/languages-and-libraries/golang), [Google Cloud](/integrations/logs/google-cloud/operations), & 
[Azure](/integrations/logs/azure/azure).
...
[Metricbeat](/integrations/logs/shippers/metricbeat) & [Heartbeat](/integrations/logs/shippers/heartbeat)), & [TCP](/integrations/logs/protocols/tcp).
