...
[Filebeat](/integrations/logs/shippers/filebeat) in the near future.
...
Journalbeat can be used to ship logs from [Kubernetes](/integrations/logs/containerisation/kubernetes) but some users may not see their data being 
reflected in Elasticsearch and may prefer to use Filebeat or [Fluentd](/integrations/logs/shippers/fluentd) for a seamless and wider community 
