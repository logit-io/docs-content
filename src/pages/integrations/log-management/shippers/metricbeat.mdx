...
subTitle: Ship Metrics with Metricbeat to Logstash
logo: metricbeat
color: "#00bfb3"
...
via [Logstash](/integrations/logs/shippers/logstash).
...
<Steps>
  ...
  - [apache](/sources/configure/metricbeat_module_apache/), 
  - [docker](/sources/configure/metricbeat_module_docker/), 
  - [golang](/sources/configure/metricbeat_module_golang/), 
  - [haproxy](/sources/configure/metricbeat_module_haproxy/), 
  - [http](/sources/configure/metricbeat_module_http/), 
  - [kafka](/sources/configure/metricbeat_module_kafka/), 
  - [kubernetes](/sources/configure/metricbeat_module_kubernetes/), 
  - [mongodb](/sources/configure/metricbeat_module_mongodb/), 
  - [mysql](/sources/configure/metricbeat_module_mysql/), 
  - [nginx](/sources/configure/metricbeat_module_nginx/), 
  - [rabbitmq](/sources/configure/metricbeat_module_rabbitmq/), 
  - [redis](/sources/configure/metricbeat_module_redis/), 
  - [centos](/sources/configure/metricbeat_module_system_centos/), 
  - [debian](/sources/configure/metricbeat_module_system_debian/), 
  - [macos](/sources/configure/metricbeat_module_system_macos/), 
  - [redhat](/sources/configure/metricbeat_module_system_redhat/), 
  - [ubuntu](/sources/configure/metricbeat_module_system_ubuntu/), 
  - [windows](/sources/configure/metricbeat_module_system_windows/), 
  - [uwsgi](/sources/configure/metricbeat_module_uwsgi/), 
  - [postgresql](/sources/configure/metricset_module_postgresql/), 
  - [zookeeper](/sources/configure/metricbeat_module_zookeeper/), 
  - [puppet](/sources/configure/puppet_server/)
...
popular tools including [NGINX](/integrations/logs/applications/nginx), 
[MySQL](/integrations/logs/applications/mysql), 
[Apache](/integrations/logs/applications/apache) & HAProxy. While Metricbeat 
can push log data directly to the Elastic Stack some users may wish to use a buffering service 
such as Redis or [Kafka](/integrations/logs/message-queues/kafka). 
