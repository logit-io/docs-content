---
title: Learn How to Integrate and Configure the Elastic Agent to Send Logs
...
<Steps>
  ...
  * Verify the required port "@logstash.sslPort" is open
  ...
  <ValidateBeat beatname="elastic-agent" />
  ...
  <LaunchStack utmMedium="logs" utmCampaign="elasticagent" source="elasticagent" />
