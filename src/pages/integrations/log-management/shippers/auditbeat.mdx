...
logo: auditbeat
color: "#19c5b9"
description: Learn how to send UDP logs to your Logstash instance using our configuration examples - Ship over 100 log data types easily with Logit.ioAuditbeat is an open-source shipping agent from Elastic that lets you ship audit data & events to Logstash & Elasticsearch (ELK).
stackTypes: logs
...
access Linux's [Auditd](/integrations/logs/applications/auditd).
