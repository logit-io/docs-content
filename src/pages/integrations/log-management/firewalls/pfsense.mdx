...
logo: pfsense
color: "#3c76d7"
description: Configure Filebeat to ship pfSense firewall logs to your Logit.io stacks. Configure Filebeat to send Palo Alto logs to Logstash or Elastic. Get started using our Palo Alto firewall example configuration.
stackTypes: logs
...
<Steps>  
  ...
  * Remote Syslog Contents: Everything
  ...
  <LaunchStack utmMedium="logs" utmCampaign="pfsense" source="pfSense" />
