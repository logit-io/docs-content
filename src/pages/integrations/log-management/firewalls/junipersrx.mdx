...
logo: junipersrx
color: "#e63429"
description: Configure Filebeat to ship Juniper SRX firewall logs to your Logit.io stacks. Configure Filebeat to send Juniper SRX logs to Logstash or Elastic. Get started using our Juniper SRX firewall example configuration.
stackTypes: logs
