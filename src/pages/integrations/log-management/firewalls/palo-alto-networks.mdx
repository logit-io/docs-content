...
logo: paloalto
color: "#e63429"
description: Configure Filebeat to ship Palo Alto Networks firewall logs to your Logit.io stacks. Configure Filebeat to send Palo Alto logs to Logstash or Elastic. Get started using our Palo Alto firewall example configuration.
stackTypes: logs
...
<Steps> 
  ...
  * Ensure all required information highlighted is entered.
  ...
  <LaunchStack utmMedium="logs" utmCampaign="paloalto" source="Palo_Alto_Networks" />
