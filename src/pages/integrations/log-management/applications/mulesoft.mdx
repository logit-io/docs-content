...
logo: mulesoft
color: "#00a1df"
description: In our quick installation guide for centralising MuleSoft log data, we'll take you through the steps needed to use AnypointStudio and configure log4j using Socket Appender to ship Mule application logging entries to Logstash or Elasticsearch.
stackTypes: logs
sslPortType: tcp-ssl
---
