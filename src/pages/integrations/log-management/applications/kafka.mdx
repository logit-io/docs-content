...
logo: kafka
color: "#723244"
description: Filebeat is a lightweight shipper that enables you to send your Apache Kafka application logs to Logstash and Elasticsearch. Configure Filebeat using the pre-defined examples below to start sending and analysing your Apache Kafka application logs.
stackTypes: logs
...
<Steps>
  ...
  <LaunchStack utmMedium="logs" utmCampaign="kafka" source="kafka" />
