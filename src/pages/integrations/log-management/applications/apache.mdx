...
color: "#cc2235"
description: Learn how to use Filebeat to send Apache application, access or error logs to your ELK stacks. Configure Filebeat to send Apache logs to Logstash or Elasticsearch. 
stackTypes: logs
