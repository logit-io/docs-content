---
title: Learn How to Integrate and Configure Syslog-NG to Send Logs
...
appliances or devices where you cannot run one of the [beats shippers](/integrations/log-management/shippers?q=shippers).
...
<Steps>
  ...
  <LaunchStack utmMedium="logs" utmCampaign="syslog" source="syslog_ng" />
