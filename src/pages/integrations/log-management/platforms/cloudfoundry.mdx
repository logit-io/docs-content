---
title: Learn How to Integrate and Configure Cloud Foundry to Send Logs
...
import BindService from "@/components/integrations/partials/cloudfoundry/bind-service";
...
commonly used programming languages, including; [Golang](/integrations/log-management/languages-and-libraries/golang), 
[Ruby](/integrations/log-management/languages-and-libraries/ruby), [Python](/integrations/log-management/languages-and-libraries/python) and [.Net Core](/integrations/log-management/languages-and-libraries/dotnet).
