...
logo: gitlab
color: "#f66000"
description: Configure Filebeat to ship GitLab logs to your Logit.io stacks. Configure Filebeat to send GitLab logs to Logstash or Elastic. Get started using our GitLab example configuration.
stackTypes: logs
