...
logo: wazuhlogo
color: "#e63429"
description: Configure Filebeat to ship Wazuh logs to your Logit.io stacks. Configure Filebeat to send Wazuh logs to Logstash or Elastic. Get started using our Wazuh example configuration.
stackTypes: logs
