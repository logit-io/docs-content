...
logo: openvpn
color: "#ea610a"
description: Configure Filebeat to ship OpenVPN logs to your Logit.io stacks. Configure Filebeat to send OpenVPN logs to Logstash or Elastic. Get started using our OpenVPN example configuration.
stackTypes: logs
...
<Steps>
  ...
  <FilebeatFilestream type="openvpn" path="/var/log/openvpnas.log\n  - /var/log/openvpnas.log.*" />
