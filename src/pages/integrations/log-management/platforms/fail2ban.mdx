...
color: "#e63429"
description: Configure Filebeat to ship Fail2ban logs to your Logit.io stacks. Configure Filebeat to send Fail2ban logs to Logstash or Elastic. Get started using our Fail2ban example configuration.
stackTypes: logs
...
<Steps>
  ...
  <FilebeatFilestream type="fail2ban" path="/var/log/fail2ban.log" />
