...
logo: bunny-net
color: "#ff9900"
description: Configure Filebeat to ship bunny.net content delivery  logs to your Logit.io stacks. Configure Filebeat to send bunny.net logs to Logstash or Elastic. Get started using our bunny.net example configuration.
stackTypes: logs
