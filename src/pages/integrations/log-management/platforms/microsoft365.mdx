...
logo: microsoft365
color: "#2e62a4"
description: Configure Filebeat to ship Microsoft 365 logs to your Logit.io stacks. Configure Filebeat to send Microsoft 365 logs to Logstash or Elastic. Get started using our Microsoft 365 example configuration.
stackTypes: logs
