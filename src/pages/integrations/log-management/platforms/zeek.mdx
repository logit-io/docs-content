...
color: "#008bb6"
description: Configure Filebeat to ship Zeek logs to your Logit.io stacks. Configure Filebeat to send Zeek logs to Logstash or Elastic. Get started using our Zeek example configuration.
stackTypes: logs
