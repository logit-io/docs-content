...
with [Red Hat](/integrations/logs/operating-systems/redhat) Enterprise Linux (RHEL). 
...
distributions (such as [Ubuntu](/integrations/logs/operating-systems/ubuntu) 
& [Debian](/integrations/logs/operating-systems/debian)).
