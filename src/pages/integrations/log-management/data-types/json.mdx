...
[Serilog](/integrations/logs/languages-and-libraries/serilog) for migrating log data from 
Microsoft's [.Net](/integrations/logs/languages-and-libraries/dotnet) or 
[.Net Core](/integrations/logs/languages-and-libraries/dotnetcore) frameworks.
...
for [Apache](/integrations/logs/applications/apache) & [NGINX](/integrations/logs/applications/nginx) 
