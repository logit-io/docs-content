---
title: Learn How to Integrate and Configure AWS Cloudtrail to Send Logs
...
This approach complements the use of [AWS Elastic Kubernetes Service (EKS)](/integrations/infrastructure-metrics/aws/aws-eks-metrics) 
