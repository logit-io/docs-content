---
title: Learn How to Integrate and Configure Amazon S3 to Send Logs
...
[Amazon ELB Application (Elastic Load Balancer)](/integrations/log-management/aws/elb-application) to ingest 
further data into our centralised platform. In addition, you can link your 
[CloudWatch metrics](/integrations/infrastructure-metrics/aws/cloudwatch) to Logit.io for comprehensive log data analysis 
