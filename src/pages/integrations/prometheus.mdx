---
title: Prometheus
metaTitle: Prometheus Integration — Ship Metrics to Logit.io
subTitle: Ship your Prometheus Metrics via Telegraf to your Logit.io Stack
logo: prometheus
color: "#4d4d4d"
description: Configure Telegraf to ship Prometheus metrics to Logit.io. Setup guide, example config, and hosted Prometheus monitoring with Grafana dashboards.
stackTypes: metrics
sslPortType: beats-ssl
tags: Telegraf, Metrics, Telemetry, OpenTelemetry, Health, Instrumentation, Prometheus, Monitoring
---

Ship Prometheus metrics to Logit.io with Telegraf: install the integration, scrape your `/metrics` endpoints, and view them in hosted Grafana. Follow the steps below to send metrics into your Logit.io stack.
...
<Steps>
  ...
  ## An array of urls to scrape metrics from.
    ...
    ## are determined by the 'method' option below. When enabled, the default is
...
If you need any further assistance with shipping your metrics data to Logit.io we're here to help you get started. 
