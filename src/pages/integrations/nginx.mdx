...
<Steps>
  ...
  <Tabs items={["Windows", "Linux", "macOS", "DEB", "RPM"]}>
    <Tab>
      ...
      Open the `nginx.yml` file with your preferred text editor and copy the snippet below, replace 
    ...
    <Tab>
      ...
      Open the `nginx.yml` file with your preferred text editor and copy the snippet below and replace 
      the contents of the nginx.yml module file and then save:
...
<Steps>
  ...
  Open the `nginx.conf` file with your preferred text editor, find the server section. Replace this section with the code snippet below and then save:
