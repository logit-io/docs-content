...
<Steps>
  ...
  var openTelemetryConfig = config.GetSection("OpenTelemetry");
  var serviceName = openTelemetryConfig.GetValue<string>("ServiceName");
  var tracingOtlpEndpoint = openTelemetryConfig.GetValue<string>("OTLP_ENDPOINT_URL");
  var tracingOtlpProtocol = openTelemetryConfig.GetValue<string>("Protocol");
  var tracingOtlpPort = openTelemetryConfig.GetValue<string>("Port");
  var tracingUsername = openTelemetryConfig.GetValue<string>("Username");
  var tracingPassword = openTelemetryConfig.GetValue<string>("Password");
  ...
  otel.WithTracing(tracing =>
  {
      ...
      if (tracingOtlpEndpoint != null)
      {
          tracing.AddOtlpExporter(otlpOptions =>
          {
              ...
              if (tracingOtlpProtocol != "grpc")
              {
                tracingOtlpEndpoint += "/v1/traces";
              }
